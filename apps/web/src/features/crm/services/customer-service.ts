...
// Initial Mock Seed Customers for Standalone / Offline Mode
const initialMockCustomers: Customer[] = [
  {
    ...
    email: 'sarah.jenkins@acuity.com',
    ...
    website: 'https://acuitysolutions.com',
    companySize: '50-200',
    status: 'ACTIVE',
    source: 'Website Lead',
    priority: 'HIGH',
    tags: ['VIP', 'Enterprise', 'High Paying'],
    isArchived: false,
    deletedAt: null,
  ...
  },
  {
    ...
    priority: 'MEDIUM',
    tags: ['Returning Customer', 'Startup'],
    isArchived: false,
    deletedAt: null,
    createdBy: 'Alex Carter',
    updatedBy: 'Alex Carter',
  ...
  },
  {
    ...
    email: 'elena.rostova@apexsys.com',
    phone: '+1 (555) 345-6789',
    country: 'Canada',
    state: 'Ontario',
    city: 'Toronto',
    address: '200 Bay St, Suite 800',
    postalCode: 'M5J 2J2',
    industry: 'Logistics & Supply Chain',
    businessType: 'PHYSICAL',
    website: 'https://apexlogistics.ca',
    companySize: '200-500',
    status: 'PROSPECT',
  ...
  },
  {
    ...
    companyId: 'comp_001',
    name: 'David Miller',
    companyName: 'Nexus Digital Group',
    email: 'd.miller@nexusdigital.com',
    phone: '+1 (555) 987-6543',
    country: 'United Kingdom',
    state: 'England',
    city: 'London',
    address: '25 Cannon St',
    postalCode: 'EC4M 5SB',
    industry: 'Digital Marketing',
    businessType: 'BOTH',
    website: 'https://nexusdigital.co.uk',
    companySize: '1-10',
    status: 'INACTIVE',
    source: 'Referral',
    priority: 'LOW',
