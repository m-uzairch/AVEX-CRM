...
import { PaymentKPISummaryCards } from '@/features/payments/components/payment-kpi-summary';
...
import { PaymentRecord, PaymentFilterState, PaymentKPISummary } from '@/features/payments/types/payment-types';
  ...
  return (
    <ContentContainer>
      <PageHeader
        ...
        description="Monitor collections, manual payment receipts, partial payments, outstanding balances, and overdue invoices."
